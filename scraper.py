...
MONGO_HOST = 'mongodb://localhost/delhipollution'  # assuming you have mongoDB installed locally

WORDS = ['#DelhiSmog', '#OddEven', '#DelhiPollution', '#Delhipollution', '#Smog', '#oddeven', '#delhipollution', '#CropBurning', '#smokeindelhi', 'Delhi']
#, '#MumbaiRains', '#CycloneOckhi', '#CropBurning']
